const TAPPA_1_DATA = {
    ...
    contenuto: [
        ...
        { type: "testo", paragrafo: "Il primo sguardo alle <em>sopravvissute</em> raggiunge la <strong>Chiesa di San Salvatore in Chora</strong>, oggi conosciuta come <strong>Moschea di Kariye (Kariye Camii)</strong>. Se ne percorrere l’esterno significa decifrare subito la sua storia complessa: un capolavoro di architettura bizantina in mattoni e pietra, con le sue cupole e absidi, a cui gli Ottomani hanno <strong>innestato</strong> il minareto dopo la conversione in moschee." },
        { type: "immagine", src: "img/istanbul_chora_chiesa_cristo_pantocrate.jpg" },
        ...
        { type: "immagine", src: "img/vista_beyoglu_corno_doro.jpg" },
        ...
        { type: "immagine", src: "minareto_yeni_camii_notte.jpg" },
        ...
        { type: "immagine", src: "img/targa_ascensore_pera.jpg" },
        ...
        { type: "video", src: "https://youtu.be/TP1s-OOxksc?is=iekH9I7VnNoOqxNq" }
    ]
};